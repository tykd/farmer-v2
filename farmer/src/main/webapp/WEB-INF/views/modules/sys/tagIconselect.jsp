...
<div id="icons">
    ...
    <ul class="the-icons">
        ...
        <li><i class="icon-jiagong">icon-jiagong</i></li>
        <li><i class="icon-wenda">icon-wenda</i></li>
        <li><i class="icon-tongzhi">icon-tongzhi</i></li>
        <li><i class="icon-zixun">icon-zixun</i></li>
        <li><i class="icon-zuoye">icon-zuoye</i></li>
        <li><i class="icon-type">icon-type</i></li>
        <li><i class="icon-jiangkong">icon-jiangkong</i></li>
        <li><i class="icon-qixiang">icon-qixiang</i></li>
        <li><i class="icon-sanno">icon-sanno</i></li>
    </ul>
